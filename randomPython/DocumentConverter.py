...
# Process each image to convert it to black and white Improves OCR
    bw_images = [image.convert('1') for image in images]  # '1' mode converts to black and white
...
#run Tesseract method  
    text = extract_text_from_image(output_tiff_path)

#Run Regex over extracted text to get vin match     
